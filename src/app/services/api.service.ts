...
export class ApiService {
  ...
  events: LiveEvent[] = [
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('03-30-2023 18:00:00'),
      end_date: new Date('03-30-2023 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('06-29-2023 18:00:00'),
      end_date: new Date('06-29-2023 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('08-31-2023 18:00:00'),
      end_date: new Date('08-31-2023 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('11-30-2023 18:00:00'),
      end_date: new Date('11-30-2023 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
