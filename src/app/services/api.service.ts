...
export class ApiService {
  ...
  events: LiveEvent[] = [
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('02/03/2024 18:00:00'),
      end_date: new Date('02/03/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
      ...
      venue_url: 'http://www.cafesmoknpi.com/',
      venue_phone: '(636) 337-5577',
      created_at: new Date('01/04/2024'),
      updated_at: new Date('01/04/2024'),
      deleted_at: new Date('01/04/2024'),
      deleted: false,
      event_type: 'restaurant',
      short_description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      image_url: '/assets/img/cafe_smok_n_pi.jfif',
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('03/02/2024 18:00:00'),
      end_date: new Date('03/02/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('03/30/2024 18:00:00'),
      end_date: new Date('03/30/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('06/29/2024 18:00:00'),
      end_date: new Date('06/29/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('08/31/2024 18:00:00'),
      end_date: new Date('08/31/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
    ...
    },
    {
      ...
      title: 'Smok N Pi',
      description: 'Me and my guitar playing music from all times, Cash to Cornell, Presley to Petty, and everything in between.',
      start_date: new Date('11/30/2024 18:00:00'),
      end_date: new Date('11/30/2024 21:00:00'),
      venue_name: 'Smok N Pi',
      venue_address: '2636 Hwy 21',
      venue_city: 'DeSoto',
      venue_state: 'Missouri',
